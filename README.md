...
<br>We used the mean squared error (MSE) to calculate the loss: 
...
<br>This is an example of each "line" the model predicts after each a epoch when the learning rate is too small:
...
<br>This is a simple example of some CIFAR-10 data:
...
<br>We ended up with around 70% accuracy which 4 layers per convolution and 256 filters per layer.
